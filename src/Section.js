...
export default class Section extends ComponentWithThumbnail {
  constructor(props) {
    super(props);
    // Flash.DEBUG(
    //     "got Section with props\nContent: %O\nItemClicked: %O\n"
    //   + "InitiallyExpanded: %s\nThumbnailLoaded: %O\nThumbnail: %s",
    //   JSON.stringify(
    //     {
    //       ID: this.props.Content.ID,
    //       Title: this.props.Content.Title,
    //       Thumbnail: this.props.Content.Thumbnail,
    //       Children: this.props.Content.Children.map(child => child.Title)
    //     },
    //     null,
    //     2
    //   ),
    //   this.props.ItemClicked,
    //   this.props.InitiallyExpanded? "true": "false",
